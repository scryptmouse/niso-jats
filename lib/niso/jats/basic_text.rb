  ...
  module Jats
    module BasicText
      def self.included(base)
        ...
        base.attribute :inline_supplementary_material, Niso::Jats::InlineSupplementaryMaterial, collection: true
        base.attribute :related_article, Niso::Jats::RelatedArticle, collection: true
        base.attribute :related_object, Niso::Jats::RelatedObject, collection: true
        ...
        base.attribute :inline_graphic, Niso::Jats::InlineGraphic, collection: true
        ...
        base.attribute :inline_formula, Niso::Jats::InlineFormula, collection: true
        ...
        base.attribute :index_term_range_end, Niso::Jats::IndexTermRangeEnd, collection: true
        base.attribute :milestone_end, Niso::Jats::MilestoneEnd, collection: true
        base.attribute :milestone_start, Niso::Jats::MilestoneStart, collection: true
        base.attribute :named_content, Niso::Jats::NamedContent, collection: true
        base.attribute :styled_content, Niso::Jats::StyledContent, collection: true
